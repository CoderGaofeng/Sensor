...
public class LoadingView extends View {
    ...
    public LoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mSize = array.getDimensionPixelSize(R.styleable.LoadingView_loading_view_size, Math.round(density * 32));
        mPaintColor = array.getInt(R.styleable.LoadingView_loading_view_color, Color.parseColor("#0c96fa"));
        array.recycle();
        initPaint();
    }
