package com.and.support.recyclerview.divider;
...
public abstract class FlexibleDividerDecoration extends RecyclerView.ItemDecoration {
    ...
    public void getItemOffsets(Rect rect, View v, RecyclerView parent, RecyclerView.State state) {
        ...
        if (!mShowLastDivider && position >= itemCount - lastDividerOffset) {
            // Don't set item footOffset for last line if mShowLastDivider = false
            return;
        }
     ...
     * Returns footOffset for how many views we don't have to draw a divider for,
     ...
     *
     * @param parent RecyclerView
     * @return footOffset for how many views we don't have to draw a divider or 1 if its a
     * LinearLayoutManager
     */
